...
By default, timelapse frames start when layer 1 begins (leveling at layer 0 is skipped). To include pre-print frames, set `Timelapse:StartAfterLayer1=false` in your settings.
